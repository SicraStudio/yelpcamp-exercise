...
//  COMMENTS ROUTES
// =============================================
// show the form for creating a new comment to the camp of the :id
            ...
            Comment.create(req.body.comment, function (err, comment) {
                if (err) {
                    ...
                    Campground.findOneAndUpdate(
                        ...
                        function () {
                            console.log("Created new comment from form");
                        }
                    );
                    // associate new comment to its campground
...
router.delete('/:comment_id', middleware.checkCommentOwnership, function(req, res) {
    // find and remove the correct comment and redirect to the show route
